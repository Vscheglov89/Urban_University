...
class WordsFinder:
    ...
    def get_all_words(self):  # Метод возвращающий словарь следующего вида:
    ...
    def find(self, word):  # Возвращает словарь, где ключ - название файла,
        # значение - позиция первого слова (word) в списке слов файла.
        answer = {}
    ...
    def count(self, word):  # Возвращает словарь, где ключ - название файла,
        # значение - количество слов (word) в списке слов файла.
        answer = {}
